...
import CardPreception from '../components/CardPreception.vue';
...
export default {
    ...
    methods: {
        ...mapActions(useCounterStore, ['fetchPrescription']),
    },
    created() {
        this.fetchPrescription()
    },
    computed: {
        ...mapState(useCounterStore, ['prescription'])
    }
}
</script>
    ...
    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
        <div class="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
            <div class="px-6 flex items-center justify-between space-x-4 2xl:container">
                <h5 hidden class="text-2xl text-gray-600 font-medium lg:block">Preception</h5>
        ...
        <section class="pt-6 px-6 pb-10 bg-[#F3F4F6]">
            <div class="container">
                <div class="flex flex-wrap -mx-4">
                    ...
                    <!-- ljkkkkkk -->
                    <CardPreception v-for="item in prescription" :key="item.id" :item="item" />
                </div>
            </div>
        </section>
    </div>
