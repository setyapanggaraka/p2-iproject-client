...
export default {
    methods: {
        ...
        toMedicine() {
            this.$router.push('/doctor-medicine')
        }
    }
}
</script>
            ...
            <ul class="space-y-2 tracking-wide mt-8">
                ...
                <li>
                    <a @click.prevent="toMedicalRecord" href="#"
                        ...
                        <span class="group-hover:text-gray-700">Medical Records</span>
                    </a>
                </li>
                <li>
                    <a @click.prevent="toPreception" href="#"
                        class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path class="fill-current text-gray-600 group-hover:text-cyan-600"
                                d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" />
                        ...
                        <span class="group-hover:text-gray-700">Preception</span>
                    </a>
                </li>
                <li>
                    <a @click.prevent="toMedicine" href="#"
                        class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path class="fill-current text-gray-600 group-hover:text-cyan-600"
                                d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" />
                        ...
                        <span class="group-hover:text-gray-700">Medicine</span>
                    </a>
                </li>
            </ul>
        </div>
